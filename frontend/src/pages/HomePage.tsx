      ...
      <section className="relative py-14 sm:py-18 lg:py-20">
        ...
        <Container className="relative">
          <div className="mx-auto max-w-3xl text-center">
            <p className="font-mono text-xs font-semibold uppercase tracking-[0.2em] text-emerald-200">Interactive Home</p>
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-zinc-50 sm:text-5xl">Welcome to My World</h1>
          ...
          <div className="mx-auto mt-10 max-w-5xl rounded-xl border border-white/10 bg-surface-900/70 p-3 shadow-glow backdrop-blur sm:p-4">
            <div className="aspect-video overflow-hidden rounded-lg border border-white/10 bg-surface-950">
              <GameScene />
            </div>
          </div>
        </Container>
